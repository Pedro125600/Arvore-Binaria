...
namespace att1_
{
    ...
    class ArvoreBinaria
    {
        ...
        public int[] CaminharCentral()
        {
            int count = 0;
            int[] v = new int[ContarElementos(raiz)];
            CaminharCentral(raiz,v,ref count);
            return v;
        }
        ...
        private void CaminharCentral(No i, int[] v, ref int count)
        {
            if (i != null)
            {
                CaminharCentral(i.Esq, v, ref count);
                v[count] = i.Elemento;
                count++;
                CaminharCentral(i.Dir, v, ref count);
            }
        }
